...
HTML;
              ...
              ?>
                ...
                <li class="nav-item dropdown <?= $menu_member_active; ?>">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <a class="dropdown-item" href="index.php?p=member"><i class="fas fa-user-circle me-3"></i> <?= themeEscape(__('Profile'));?></a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="index.php?p=member&sec=bookmark"><i class="fas fa-bookmark me-3"></i> <?= themeEscape(__('Bookmark'));?></a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="index.php?p=member&logout=1"><i class="fas fa-sign-out-alt me-3"></i> <?= themeEscape(__('Logout')); ?></a>
                    </div>
                </li>
            <?php } else { ?>
                <li class="nav-item <?= $menu_member_active; ?>">
    ...
    <a class="dropdown-item" href="index.php?select_lang={$safe_lang_code}">
        <span class="flag-icon flag-icon-{$safe_code_flag} me-2 flag-icon-rounded"></span> {$safe_lang_name}
    </a>
HTML;
              }
            if ($langstr !== '') { ?>
