...
<?php endif; ?>
<script src="<?php echo assetsVersioned('js/footer_helpers.js'); ?>"></script>

<!-- // load our vue app.js -->
<script src="<?php echo assetsVersioned('js/app.js'); ?>"></script>
...
<?php endif; ?>
<?php
$cursor_particles = themeEffectiveTemplateValue('classic_cursor_particles', 'auto', $sysconf);
if ($cursor_particles !== 'none'):
?>
