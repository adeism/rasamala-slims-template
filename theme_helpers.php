...
if (!function_exists('themePresetDefinitions')) {
  function themePresetDefinitions()
  {
    return [
      'simple_homepage' => [
        'label' => 'Minimal Search Only',
        'description' => 'Tampilan beranda minimalis yang hanya berfokus pada kotak pencarian utama. Sangat cocok untuk kios pencarian mandiri di perpustakaan.',
        'footer_home' => false,
        'settings' => [
      ...
      'all_show' => [
        'label' => 'Full Library Portal',
        'description' => 'Portal perpustakaan lengkap dengan menampilkan semua bagian beranda, peta informasi, berita, running text, dan footer.',
        'footer_home' => true,
        'settings' => [
      ...
      'office' => [
        'label' => 'Corporate / Formal Portal',
        'description' => 'Layout profesional yang rapi dan formal untuk instansi/kantor. Berfokus pada topik, koleksi terbaru, dan peta.',
        'footer_home' => true,
        'settings' => [
          'classic_homepage_only_hero' => 0,
          'classic_topic_show' => 1,
          ...
          'classic_font_family' => 'inter',
          'classic_hero_background_animation' => 'grid',
