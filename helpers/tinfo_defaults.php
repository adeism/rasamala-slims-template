...
$sysconf['template']['classic_whatsapp_desc'] = 'Pustakawan; Halo, silakan ketik pesan Anda langsung di kolom bawah. Agar kami dapat membantu lebih cepat, tuliskan nama, nomor anggota (jika ada), lalu pertanyaan Anda.';
...
$sysconf['template']['classic_theme_color'] = 'minimalwhite';
...
$sysconf['template']['classic_palette_switcher_show'] = 0;
